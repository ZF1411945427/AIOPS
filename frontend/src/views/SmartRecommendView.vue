    ...
    <div v-if="alert" class="panel">
      ...
      <div class="panel-body">
        <div class="alert-grid">
          ...
          <div class="alert-field"><span class="alert-label">指标</span><span class="alert-val">{{ alert.metric || alert.name || '-' }}</span></div>
        ...
        <div v-else class="rec-list">
          <div v-for="(r, i) in recommendations" :key="i" class="rec-item">
            <div class="rec-head">
              ...
              <span class="rec-score">相似度 {{ ((r.score || r.similarity || 0) * 100).toFixed(1) }}%</span>
              <span v-if="r.linked" class="badge linked">已关联</span>
            </div>
            <div v-if="r.kb?.severity" class="rec-meta">
              <span class="badge" :class="sevClass(r.kb.severity)">{{ r.kb.severity }}</span>
