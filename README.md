...
<details open>
<summary><b>🖥️ 可观测性</b> — 仪表盘 · 指标 · 日志 · 链路 · 拓扑</summary>
...
<details open>
<summary><b>🚨 告警与事件</b> — 规则 · 聚合 · 静默 · 风暴 · Webhook</summary>
...
<details open>
<summary><b>🔍 根因分析</b> — 6 种算法引擎</summary>

| 算法 | 类型 | 适用场景 | 实现状态 |
|------|------|----------|----------|
| **PageRank** | 拓扑排序 | 从故障传播链定位关键节点 | ✅ 真实实现 |
| **Granger** | 因果检验 | 指标间因果关系判定 | ✅ 真实实现（statsmodels 双向检验，`/granger/analyze`） |
| **DTW** | 时序相似度 | 指标曲线形态匹配 | ✅ 真实实现 |
| **LogClu** | 日志聚类 | 日志异常模式发现 | ✅ 真实实现（Drain 树形在线聚类，`/drain/cluster`） |
| **IDCE** | 异常子图归因 | 拓扑异常子图检测 | 🟡 v1 相关归因（`method=idice-v1`，诚实标注，非控制因果） |
| **PCADr** | 维度规约 | 高维指标降维归因 | ✅ 真实实现 |
</details>

<details open>
<summary><b>⚡ 自动化运维</b> — 自愈 · Runbook · 脚本 · 变更 · 通知</summary>
...
<details open>
<summary><b>📊 SRE 可靠性工程</b> — SLO · Error Budget · 值班 · SLA · 报表</summary>
...
<details open>
<summary><b>💬 AI Agent</b> — 对话排障 · MCP 工具 · 多模型适配</summary>
